...
@Service
public class OrderCancelledServiceImpl implements OrderCancelledService {

    public static final String BODY_TEMPLATE_ORDER_CANCELLED = "template/mail/OrderCancelled/Body";
    public static final String SUBJECT_TEMPLATE_ORDER_CANCELLED = "template/mail/OrderCancelled/Subject";

    private static final Logger LOG = LoggerFactory.getLogger(OrderCancelledServiceImpl.class);
    ...
    public OrderCancelledServiceImpl(OrderServiceClient orderServiceClient,
