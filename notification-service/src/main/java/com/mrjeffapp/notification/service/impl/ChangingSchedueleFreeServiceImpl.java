...
@Service
public class ChangingSchedueleFreeServiceImpl implements ChangingSchedueleFreeService {

    public static  final String BODY_TEMPLATE_CHANGING_SCHEDUELE = "template/mail/ChangingScheduleFree/Body";
    public static  final String SUBJECT_TEMPLATE_CHANGING_SCHEDUELE = "template/mail/ChangingScheduleFree/Subject";

    private static final Logger LOG = LoggerFactory.getLogger(ChangingSchedueleFreeServiceImpl.class);
    ...
    public ChangingSchedueleFreeServiceImpl(OrderServiceClient orderServiceClient,
    ...
    @Override
    public void sendChangingScheduleFreeEmail(String orderId) {
