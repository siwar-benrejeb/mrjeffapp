...
@Service
public class ReminderUnpaidOrder30MinutesServiceImpl implements ReminderUnpaidOrder30MinutesService {
    public static final String BODY_TEMPLATE_ORDER_UNPAID = "template/mail/ReminderUnpaidOrder30Minutes/Body";
    public static final String SUBJECT_TEMPLATE_ORDER_UNPAID = "template/mail/ReminderUnpaidOrder30Minutes/Subject";

    private static final Logger LOG = LoggerFactory.getLogger(ReminderUnpaidOrder30MinutesServiceImpl.class);
    private static final String EMAIL_TYPE_CODE = "REMINDER_ORDER_UNPAID_30MINUTES";
    ...
    public ReminderUnpaidOrder30MinutesServiceImpl(OrderServiceClient orderServiceClient,
    ...
    @Override
    public void sendReminderUnpaidOrdderEmail(String orderId) {
        ...
        String emailContent = templateService.renderBodyTemplate(BODY_TEMPLATE_ORDER_UNPAID,languageCode, parameters);
        String emailDestination = emailDestinationResolver.getDestinationEmail(customer);
        String emailSubject = templateService.renderSubjectTemplate(SUBJECT_TEMPLATE_ORDER_UNPAID,languageCode,parameters);
