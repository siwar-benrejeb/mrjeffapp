...
@Service
public class ReminderUnpaidOrderServiceImpl implements ReminderUnpaidOrderService {
    public static final String BODY_TEMPLATE_ORDER_UNPAID = "template/mail/ReminderUnpaidOrder/Body";
    public static final String SUBJECT_TEMPLATE_ORDER_UNPAID = "template/mail/ReminderUnpaidOrder/Subject";

    private static final Logger LOG = LoggerFactory.getLogger(ReminderUnpaidOrderServiceImpl.class);
    ...
    public ReminderUnpaidOrderServiceImpl(OrderServiceClient orderServiceClient,
