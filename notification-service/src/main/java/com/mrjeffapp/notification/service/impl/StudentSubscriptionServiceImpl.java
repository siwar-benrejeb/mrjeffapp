...
public class StudentSubscriptionServiceImpl implements StudentSubscriptionService {
    public static final String BODY_TEMPLATE_STUDENT_SUBSCRIPTION = "template/mail/StudentSubscription/Body";
    public static final String SUBJECT_TEMPLATE_STUDENT_SUBSCRIPTION = "template/mail/StudentSubscription/Subject";

    private final static Logger LOG = LoggerFactory.getLogger(StudentSubscriptionServiceImpl.class);
    ...
    @Autowired
    public StudentSubscriptionServiceImpl(CustomerServiceClient customerServiceClient,
    ...
    @Override
    public void sendStudentSubscriptionEmail(String customerId) {
        ...
        String emailContent = templateService.renderBodyTemplate(BODY_TEMPLATE_STUDENT_SUBSCRIPTION,languageCode, parameters);
        String emailDestination = emailDestinationResolver.getDestinationEmail(customer);
        String emailSubject = templateService.renderSubjectTemplate(SUBJECT_TEMPLATE_STUDENT_SUBSCRIPTION,languageCode,parameters);
