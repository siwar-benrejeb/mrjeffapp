...
public class OrderCancelledUnpaidServiceImplTest {
    private static final String ORDER_ID = "0000a2e7-228e-465c-8bc6-ddb1e7724e5c";
    private static final String PROJECTION = "full";
    private static final String BODY_TEMPLATE_ORDER_CANCELLED = "template/mail/OrderCancelledUnpaid/Body";
    private static final String SUBJECT_TEMPLATE_ORDER_CANCELLED = "template/mail/OrderCancelledUnpaid/Subject";
    ...
    @InjectMocks
    private OrderCancelledUnpaidServiceImpl orderCancelledUnpaidService;
    private Order order;
    ...
    public void testValidBodyTemplatePath() {
        assertThat("the body template path must be", orderCancelledUnpaidService.BODY_TEMPLATE_ORDER_CANCELLED, is(BODY_TEMPLATE_ORDER_CANCELLED));

    }
    @Test
    public void testValidSubjectTemplatePath(){
        assertThat("the subject template path must be", orderCancelledUnpaidService.SUBJECT_TEMPLATE_ORDER_CANCELLED, is(SUBJECT_TEMPLATE_ORDER_CANCELLED));
    ...
    public void testSendOrderCancelledUnpaidEmail() {
        ...
        orderCancelledUnpaidService.sendOrderCancelledUnpaidEmail(ORDER_ID);
