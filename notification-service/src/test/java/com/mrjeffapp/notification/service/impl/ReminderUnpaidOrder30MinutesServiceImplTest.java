...
public class ReminderUnpaidOrder30MinutesServiceImplTest {
    private static final String ORDER_ID = "0000a2e7-228e-465c-8bc6-ddb1e7724e5c";
    private static final String PROJECTION = "full";
    private static final String BODY_TEMPLATE_ORDER_UNPAID = "template/mail/ReminderUnpaidOrder30Minutes/Body";
    private static final String SUBJECT_TEMPLATE_ORDER_UNPAID = "template/mail/ReminderUnpaidOrder30Minutes/Subject";
    ...
    @InjectMocks
    private ReminderUnpaidOrder30MinutesServiceImpl reminderUnpaidOrderService;
    private Order order;
    ...
    public void testValidSubjectTemplatePath() {
        assertThat("the template path must be", reminderUnpaidOrderService.SUBJECT_TEMPLATE_ORDER_UNPAID, is(SUBJECT_TEMPLATE_ORDER_UNPAID));


    }

    @Test
    public void testSendReminderUnpaidOrdderEmail() {
        ...
        reminderUnpaidOrderService.sendReminderUnpaidOrdderEmail(ORDER_ID);
