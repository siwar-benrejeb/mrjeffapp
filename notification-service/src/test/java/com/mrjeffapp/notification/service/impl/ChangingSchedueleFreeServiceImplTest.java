...
public class ChangingSchedueleFreeServiceImplTest {
    private static final String ORDER_ID = "0000a2e7-228e-465c-8bc6-ddb1e7724e5c";
    private static final String PROJECTION = "full";
    private static final String BODY_TEMPLATE_CHANGING_SCHEDUELE = "template/mail/ChangingScheduleFree/Body";
    private static final String SUBJECT_TEMPLATE_CHANGING_SCHEDUELE = "template/mail/ChangingScheduleFree/Subject";

    private static final String CUSTOMER_ID = "3039faa2-e73c-42be-9519-07315c1dfdae";
    private static final String EMAIL_TYPE_CODE = "CHANGING_SCHEDUELE_FREE";
    ...
    @InjectMocks
    private ChangingSchedueleFreeServiceImpl changingSchedueleFreeService;
    private Order order;
    ...
    public void testValidBodyTemplatePath() {
        assertThat("the body template path must be", changingSchedueleFreeService.BODY_TEMPLATE_CHANGING_SCHEDUELE, is(BODY_TEMPLATE_CHANGING_SCHEDUELE));

    }

    @Test
    public void testValidSubjectTemplatePath() {
        assertThat("the subject template path must be", changingSchedueleFreeService.SUBJECT_TEMPLATE_CHANGING_SCHEDUELE, is(SUBJECT_TEMPLATE_CHANGING_SCHEDUELE));


    }

    @Test
    public void testSendChangingScheduleFreeEmail() {
        ...
        changingSchedueleFreeService.sendChangingScheduleFreeEmail(ORDER_ID);
